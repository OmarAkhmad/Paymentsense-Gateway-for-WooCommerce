...
<form action="<?php echo esc_url( $paymentsense_adr ); ?>" method="post" id="paymentsense_payment_form" target="_top">
	...
	<div class="payment_buttons">
		<input type="submit" class="button alt" id="submit_paymentsense_payment_form" value="><?php __( 'Pay via Paymentsense', 'woocommerce-paymentsense' ); ?>" /> <a class="button cancel" href="<?php esc_url( $cancel_url ); ?>"><?php __( 'Cancel order &amp; restore cart', 'woocommerce-paymentsense' ); ?></a>
	</div>
</form>
